...
def send_email():
    Sender_Email = "200701257@rajalakshmi.edu.in"
    Reciever_Email = "subeash18@gmail.com"
    Password = "REC202099529"
    ...
    if len(idxs) > 0:
        ...
        for i in idxs.flatten():
            ...
            if ( LABELS[classIDs[i]] == "person" ):
                if ( not sent_mail ):
                    '''Subscribe to receive notifications : https://notify.run/c/DYqReDqmGgpqFCnJx0tK'''
                    notify.send('ALERT! HUMAN DETECTED!!!')
